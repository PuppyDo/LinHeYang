...
public class EnemyTank01 extends Tank implements Runnable {
    //在敌人坦克类，保存多个shot
    private Vector<Shot> shots = new Vector<>();
    //敌人坦克 可以得到敌人坦克的Vector
    //1.EnemyTank 在mypanel里面
    private Vector<EnemyTank01> enemyTanks = new Vector<>();

    public EnemyTank01(int x, int y) {
        super(x, y);
    }
    ...
    public Vector<EnemyTank01> getEnemyTanks() {
        return enemyTanks;
    }
     ...
     */
    public void setEnemyTanks(Vector<EnemyTank01> enemyTanks) {
